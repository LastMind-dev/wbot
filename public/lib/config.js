...
const RESILIENCE_CONFIG = {
    ...
    // ═══════════════════════════════════════════════════════════════
    HEARTBEAT_INTERVAL: 15000,          // Ping a cada 15 segundos
    ...
    RECOVERY_CHECK_INTERVAL: 60000,     // Recovery check a cada 1 min
    ...
    MAX_CONSECUTIVE_FAILURES: 3,        // Falhas antes de forçar reconexão
