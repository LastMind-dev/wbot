...
class SessionState {
    ...
    toJSON() {
        return {
            ...
            hasBrowser: (this.client && this.client.pupBrowser && this.client.pupBrowser.isConnected()) || false,
            hasPage: (this.client && this.client.pupPage && !this.client.pupPage.isClosed()) || false,
            hasQr: !!this.qr,
